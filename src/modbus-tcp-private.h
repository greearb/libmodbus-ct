...
#define _MODBUS_TCP_XINJE_READ_PRESET_REQ_LENGTH 14
#define _MODBUS_TCP_XINJE_WRITE_COIL_PRESET_REQ_LENGTH 16
#define _MODBUS_TCP_XINJE_WRITE_REG_PRESET_REQ_LENGTH 19
